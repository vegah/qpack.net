...
namespace Fantasista
{
    public class QPack
    {
        ...
        private byte[] PackMap(IDictionary o)
        {
        ...
        private byte[] PackArray(IEnumerable o)
        {
                var bytes = new List<byte>();
                var counter = 0;
        ...
        private byte[] PackString(string s)
        {
            long l;
            double d;
        ...
        private byte[] PackActualString(string s)
        {
        ...
        private byte[] PackFloat(double o)
        {
